...
import { useComponentDefaultProps, useMantineTheme, ColorSwatch, Popover, SimpleGrid, ColorPicker, Tooltip, Group, ActionIcon } from '@mantine/core';
...
const ColorPickerControl = forwardRef((props, ref) => {
  ...
  const currentColor = (editor == null ? void 0 : editor.getAttributes("textStyle").color) || theme.colorScheme === "dark" ? theme.colors.dark[1] : theme.black;
